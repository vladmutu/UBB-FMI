...
/*
 * functie de test pentru raport
 */
void testRaport();

/*
functie de test pentru exceptia din service
*/
void testServiceExceptionMsg();

/*
 * functie de test pentru salvarea in fisier a masinilor din spalatorie
 */
void testSaveToFileSpalatorieService();

/*
 * functie de test pentru salvarea in fisier
 */
...
/*
 * functie de test pentru repo fisier load/save
 */
void testRepoFisier();
