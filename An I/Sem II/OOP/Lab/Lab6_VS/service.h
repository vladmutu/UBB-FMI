...
public:
     ...
     */
    VectorDinamic<Masina> getAllMasiniService();

    /*
     * returneaza o lista filtrata dupa producator
     */
    VectorDinamic<Masina> filterMasiniProducer(string& producator);

    /*
     * returneaza o lista filtrata dupa tip
     */
    VectorDinamic<Masina> filterMasiniType(string& tip);

    /*
     * returneaza o lista sortate dupa o functie de sortare
     */
    VectorDinamic<Masina> sortMasini(Sort functieSortare);
